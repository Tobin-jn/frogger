...
module.exports = class Game {
  constructor(ctx) {
    ...
    this.cars = [  
      new Car(200, 450, 10, 10, 'blue', 1, 'black'),
      new Car(600, 450, 10, 10, 'blue', 1, 'black'),
      new Car(0, 450, 10, 10, 'blue', 1, 'black'),
      new Car(50, 550, 10, 10, 'green', -1, 'black'),
      new Car(700, 550, 10, 10, 'green', -1, 'black'),
      new Car(300, 550, 10, 10, 'green', -1, 'black'),
      new Car(10, 650, 10, 10, 'blue', 1, 'black'), 
      new Car(600, 650, 10, 10, 'blue', 1, 'black'), 
      new Car(110, 650, 10, 10, 'blue', 1, 'black') 
    ];

    this.frogs = [
      new Frog(250, 450, 25, 25, 'lime')
    ];
  ...
  handleKeyPress(e) {
    ...
    this.frogs.forEach( frog => frog.changeDirection(direction) );
  }
